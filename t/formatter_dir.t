...
like($ret, qr{<div id="dirs"><ul><li><a href="/test">..</a></li></ul></div>\n<div id="files"><ul></ul></div>\n}s, "Format empty directory in xhtml");

$dir->mkdir('foo');

$ret = MojoMojo::Formatter::Dir->to_xhtml($dir, $exclude, $baseuri, $path);
like($ret, qr{<div id="dirs"><ul><li><a href="/test">..</a></li><li><a href="/test/foo">\[foo\]</a></li></ul></div>\n<div id="files"><ul></ul></div>\n}s,"Just a foo directory in xhtml");
